...
<html>
  ...
  @media screen and (max-width: 450px) {
    ...
    .border-button {
      color: rgba(255, 170, 80, 1) !important;
      border-color: rgba(255, 170, 80, 1) !important;
    }
    .button {
      background-color: rgba(255, 170, 80, 1) !important;
...
<div class="content-container shadow">
  ...
  <div class="context secondary-text-color">
    ...
    <p>
Looks like we are having some issues. If you think something is not right, please report the incident and do not forget to mention: the process that you were performing and the time when you receive the error
    </p>


  </div>
	<div class="buttons-container single-button">
		<a class="button" href="https://iadb.service-now.com/ite/com.glideapp.servicecatalog_cat_item_view.do?v=1&sysparm_id=d08783290f06b600d15605cce1050eb3&sysparm_link_parent=245740b30f30310070ef7d4ce1050e4e&sysparm_catalog=aa324a540f5fa100d15605cce1050e45&sysparm_catalog_view=catalog_default" target="_blank"><span class="fa fa-warning"></span> Create an incident</a>
	</div>
</div>

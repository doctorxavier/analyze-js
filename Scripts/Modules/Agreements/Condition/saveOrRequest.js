...
function getvalue(select) {
    ...
    if (optionSelected == "0" || optionSelected == "Single") {
        ...
        if (parseInt($('#ConditionId').val()) != 0 && $('#ConditionId').val() != undefined) {
            if ($('#datePicker10').val() != "") {
...
$(document).ready(function () {
    ...
    function activeFields() {
        ...
        if (isRadioBtnToDependencyChecked) {
            $('#muestradatedown').toggle();
            $('#muestratododown').toggle();
        }
    ...
    jQuery.validator.addMethod("inputNumber", function (value, element) {
        if (value == '') {
            $(element).attr('data-val-required', MessageTranslation._texts['fillRequired']);
            AsignarClaseDatePicker();
            return false;
        }
    ...
    jQuery.validator.addMethod("inputDescription", function (value, element) {
        if (value == '') {
            $(element).attr('data-val-required', MessageTranslation._texts['fillRequired']);
            AsignarClaseDatePicker();
            return false;
    ...
    $('.save').on('click', function () {
        ...
        form = form.removeData("validator").removeData("unobtrusiveValidation");

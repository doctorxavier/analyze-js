$(document).on("click", ".lnkModal", function () {
    ...
    var stringhtml = '<div style="margin:20px;">"Please note that the Syntethic Indicator and the Classification are not calculated for Performance Driven Loans (PDL), Policy based Loans (PBL), Programmatic Policy based Loans (PBPs), and Hybrid operations (HYB). Also, please note that indicators based on disbursement and Earned Value (SPI, SPI(a), CPI, CPI(a), expected additional duration time) are not calculated. All other indicators are calculated for tracking purposes only. The system uses different data sources depending on the current PMR Cycle:</div>' +
                       '<p class="headingh3" style="margin:30px 10px 10px 20px;">March PMR Cycle</p>' +
                       '<div style="margin:20px;">The system displays the indicators referring to the period January 1st - December 31st of the previous year</div>' +
                       '<div style="margin:20px; font-family: OpenSans-Italic; font-size: 0.85em;">Note: If the current date is earlier than December 31st, indicators refer to the current year (January 1st - Current date)</div>' +
                       '<p class="headingh3" style="margin:30px 10px 10px 20px;">September PMR Cycle</p>' +
                       '<div style="margin:20px;">The system displays the indicators referring to the period January 1st - June 30th of the current year</div>' +
                       '<div style="margin:20px; font-family: OpenSans-Italic; font-size: 0.85em;">Note: If the current date is earlier than December 31st, indicators refer to the current year (January 1st - Current date)"</div>' +

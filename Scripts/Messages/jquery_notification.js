...
function showNotification(params) {
   ...
   container += '</div><div title="Close" class="info_close_btn button_area" onclick="return closeNotification()"></div><div class="clearboth"></div>';
   ...
   //$(window.parent.document.body).append($notification); // With Iframe

   //var divHeight = $('div#info_message').height();
   var divHeight = $(bodyElement).find('div#info_message').height();
   // see CSS top to minus of div height
   /*$(bodyElement).find('div#info_message').css({
      top: '-' + divHeight + 'px'
   });*/

   // showing notification message, default it will be hidden
   $(bodyElement).find('div#info_message').show();
